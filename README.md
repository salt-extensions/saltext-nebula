# Salt Extension for Nebula

Salt Extension for interacting with Nebula
...
The saltext-nebula project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-nebula.git
...
* Writing blog posts
* Sharing your experiences using Salt + Nebula
  on social media
...
[issues]: https://github.com/salt-extensions/saltext-nebula/issues
[PRs]: https://github.com/salt-extensions/saltext-nebula/pulls
[discussions]: https://github.com/salt-extensions/saltext-nebula/discussions
[comments]: https://conventionalcomments.org/
[docs]: https://salt-extensions.github.io/saltext-nebula/
